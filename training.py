...
class TiagoMazeSolver(gym.Env, Supervisor):
    ...
    def reset(self):
        ...
        initial_state_index = self.state_to_index(observation)
    ...
    def save_model(self, q_table_filename, params_filename):
    ...
    def load_model(self, q_table_filename, params_filename):
    ...
    def train(self, num_episodes, evaluation_interval=50, num_evaluation_episodes=10):
        save_interval = 50
        ...
        for episode in range(num_episodes):
            ...
            if (episode + 1) % save_interval == 0:
                self.save_model(f'q_table_episodes_{episode + 1}.npy', f'training_params_episodes_{episode + 1}.json')
...
if __name__ == "__main__":
    ...
    env.train(num_episodes, evaluation_interval, num_evaluation_episodes)
